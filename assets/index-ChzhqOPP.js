 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Xd;function Xh(){if(Xd)return Bs;Xd=1;var r=Ut();function i(v,g){return v===g&&(v!==0||1/v===1/g)||v!==v&&g!==g}var a=typeof Object.is=="function"?Object.is:i,s=r.useSyncExternalStore,d=r.useRef,f=r.useEffect,m=r.useMemo,y=r.useDebugValue;return Bs.useSyncExternalStoreWithSelector=function(v,g,p,x,N){var k=d(null);if(k.current===null){var b={hasValue:!1,value:null};k.current=b}else b=k.current;k=m(function(){function S(H){if(!_){if(_=!0,R=H,H=x(H),N!==void 0&&b.hasValue){var B=b.value;if(N(B,H))return A=B}return A=H}if(B=A,a(R,H))return B;var F=x(H);return N!==void 0&&N(B,F)?(R=H,B):(R=H,A=F)}var _=!1,R,A,D=p===void 0?null:p;return[function(){return S(g())},D===null?void 0:function(){return S(D())}]},[g,p,x,N]);var C=s(v,k[0],k[1]);return f(function(){b.hasValue=!0,b.value=C},[C]),y(C),C},Bs}var Kd;function Kh(){return Kd||(Kd=1,Hs.exports=Xh()),Hs.exports}var Yh=Kh();function Zh(r){r()}function $h(){let r=null,i=null;return{clear(){r=null,i=null},notify(){Zh(()=>{let a=r;for(;a;)a.callback(),a=a.next})},get(){const a=[];let s=r;for(;s;)a.push(s),s=s.next;return a},subscribe(a){let s=!0;const d=i={callback:a,next:null,prev:i};return d.prev?d.prev.next=d:r=d,function(){!s||r===null||(s=!1,d.next?d.next.prev=d.prev:i=d.prev,d.prev?d.prev.next=d.next:r=d.next)}}}}var Yd={notify(){},get:()=>[]};function Gh(r,i){let a,s=Yd,d=0,f=!1;function m(C){p();const S=s.subscribe(C);let _=!1;return()=>{_||(_=!0,S(),x())}}function y(){s.notify()}function v(){b.onStateChange&&b.onStateChange()}function g(){return f}function p(){d++,a||(a=r.subscribe(v),s=$h())}function x(){d--,a&&d===0&&(a(),a=void 0,s.clear(),s=Yd)}function N(){f||(f=!0,p())}function k(){f&&(f=!1,x())}const b={addNestedSub:m,notifyNestedSubs:y,handleChangeWrapper:v,isSubscribed:g,trySubscribe:N,tryUnsubscribe:k,getListeners:()=>s};return b}var Jh=()=>typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",em=Jh(),tm=()=>typeof navigator<"u"&&navigator.product==="ReactNative",nm=tm(),rm=()=>em||nm?L.useLayoutEffect:L.useEffect,om=rm(),im=Symbol.for("react-redux-context"),am=typeof globalThis<"u"?globalThis:{};function lm(){if(!L.createContext)return{};const r=am[im]??=new Map;let i=r.get(L.createContext);return i||(i=L.createContext(null),r.set(L.createContext,i)),i}var fa=lm();function sm(r){const{children:i,context:a,serverState:s,store:d}=r,f=L.useMemo(()=>{const v=Gh(d);return{store:d,subscription:v,getServerState:s?()=>s:void 0}},[d,s]),m=L.useMemo(()=>d.getState(),[d]);om(()=>{const{subscription:v}=f;return v.onStateChange=v.notifyNestedSubs,v.trySubscribe(),m!==d.getState()&&v.notifyNestedSubs(),()=>{v.tryUnsubscribe(),v.onStateChange=void 0}},[f,m]);const y=a||fa;return L.createElement(y.Provider,{value:f},i)}var um=sm;function Ef(r=fa){return function(){return L.useContext(r)}}var cm=Ef(),dm=(r,i)=>r===i;function fm(r=fa){const i=r===fa?cm:Ef(r),a=(s,d={})=>{const{equalityFn:f=dm}=typeof d=="function"?{equalityFn:d}:d,m=i(),{store:y,subscription:v,getServerState:g}=m;L.useRef(!0);const p=L.useCallback({[s.name](N){return s(N)}}[s.name],[s]),x=Yh.useSyncExternalStoreWithSelector(v.addNestedSub,y.getState,g||y.getState,p,f);return L.useDebugValue(x),x};return Object.assign(a,{withTypes:()=>a}),a}var pm=fm();/**
 * react-router v7.9.3
 *
...
}`);var me=function(){return me=Object.assign||function(r){for(var i,a=1,s=arguments.length;a<s;a++)for(var d in i=arguments[a])Object.prototype.hasOwnProperty.call(i,d)&&(r[d]=i[d]);return r},me.apply(this,arguments)};function ha(r){return ha=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(i){return typeof i}:function(i){return i&&typeof Symbol=="function"&&i.constructor===Symbol&&i!==Symbol.prototype?"symbol":typeof i},ha(r)}var $1=/^\s+/,G1=/\s+$/;function oe(r,i){if(i=i||{},(r=r||"")instanceof oe)return r;if(!(this instanceof oe))return new oe(r,i);var a=(function(s){var d={r:0,g:0,b:0},f=1,m=null,y=null,v=null,g=!1,p=!1;typeof s=="string"&&(s=(function(b){b=b.replace($1,"").replace(G1,"").toLowerCase();var C,S=!1;if($s[b])b=$s[b],S=!0;else if(b=="transparent")return{r:0,g:0,b:0,a:0,format:"name"};return(C=Nt.rgb.exec(b))?{r:C[1],g:C[2],b:C[3]}:(C=Nt.rgba.exec(b))?{r:C[1],g:C[2],b:C[3],a:C[4]}:(C=Nt.hsl.exec(b))?{h:C[1],s:C[2],l:C[3]}:(C=Nt.hsla.exec(b))?{h:C[1],s:C[2],l:C[3],a:C[4]}:(C=Nt.hsv.exec(b))?{h:C[1],s:C[2],v:C[3]}:(C=Nt.hsva.exec(b))?{h:C[1],s:C[2],v:C[3],a:C[4]}:(C=Nt.hex8.exec(b))?{r:ft(C[1]),g:ft(C[2]),b:ft(C[3]),a:lf(C[4]),format:S?"name":"hex8"}:(C=Nt.hex6.exec(b))?{r:ft(C[1]),g:ft(C[2]),b:ft(C[3]),format:S?"name":"hex"}:(C=Nt.hex4.exec(b))?{r:ft(C[1]+""+C[1]),g:ft(C[2]+""+C[2]),b:ft(C[3]+""+C[3]),a:lf(C[4]+""+C[4]),format:S?"name":"hex8"}:(C=Nt.hex3.exec(b))?{r:ft(C[1]+""+C[1]),g:ft(C[2]+""+C[2]),b:ft(C[3]+""+C[3]),format:S?"name":"hex"}:!1})(s)),ha(s)=="object"&&(Jt(s.r)&&Jt(s.g)&&Jt(s.b)?(x=s.r,N=s.g,k=s.b,d={r:255*Re(x,255),g:255*Re(N,255),b:255*Re(k,255)},g=!0,p=String(s.r).substr(-1)==="%"?"prgb":"rgb"):Jt(s.h)&&Jt(s.s)&&Jt(s.v)?(m=uo(s.s),y=uo(s.v),d=(function(b,C,S){b=6*Re(b,360),C=Re(C,100),S=Re(S,100);var _=Math.floor(b),R=b-_,A=S*(1-C),D=S*(1-R*C),H=S*(1-(1-R)*C),B=_%6,F=[S,D,A,A,H,S][B],K=[H,S,S,D,A,A][B],Y=[A,A,H,S,S,D][B];return{r:255*F,g:255*K,b:255*Y}})(s.h,m,y),g=!0,p="hsv"):Jt(s.h)&&Jt(s.s)&&Jt(s.l)&&(m=uo(s.s),v=uo(s.l),d=(function(b,C,S){var _,R,A;function D(F,K,Y){return Y<0&&(Y+=1),Y>1&&(Y-=1),Y<1/6?F+6*(K-F)*Y:Y<.5?K:Y<2/3?F+(K-F)*(2/3-Y)*6:F}if(b=Re(b,360),C=Re(C,100),S=Re(S,100),C===0)_=R=A=S;else{var H=S<.5?S*(1+C):S+C-S*C,B=2*S-H;_=D(B,H,b+1/3),R=D(B,H,b),A=D(B,H,b-1/3)}return{r:255*_,g:255*R,b:255*A}})(s.h,m,v),g=!0,p="hsl"),s.hasOwnProperty("a")&&(f=s.a));var x,N,k;return f=qf(f),{ok:g,format:s.format||p,r:Math.min(255,Math.max(d.r,0)),g:Math.min(255,Math.max(d.g,0)),b:Math.min(255,Math.max(d.b,0)),a:f}})(r);this._originalInput=r,this._r=a.r,this._g=a.g,this._b=a.b,this._a=a.a,this._roundA=Math.round(100*this._a)/100,this._format=i.format||a.format,this._gradientType=i.gradientType,this._r<1&&(this._r=Math.round(this._r)),this._g<1&&(this._g=Math.round(this._g)),this._b<1&&(this._b=Math.round(this._b)),this._ok=a.ok}function tf(r,i,a){r=Re(r,255),i=Re(i,255),a=Re(a,255);var s,d,f=Math.max(r,i,a),m=Math.min(r,i,a),y=(f+m)/2;if(f==m)s=d=0;else{var v=f-m;switch(d=y>.5?v/(2-f-m):v/(f+m),f){case r:s=(i-a)/v+(i<a?6:0);break;case i:s=(a-r)/v+2;break;case a:s=(r-i)/v+4}s/=6}return{h:s,s:d,l:y}}function nf(r,i,a){r=Re(r,255),i=Re(i,255),a=Re(a,255);var s,d,f=Math.max(r,i,a),m=Math.min(r,i,a),y=f,v=f-m;if(d=f===0?0:v/f,f==m)s=0;else{switch(f){case r:s=(i-a)/v+(i<a?6:0);break;case i:s=(a-r)/v+2;break;case a:s=(r-i)/v+4}s/=6}return{h:s,s:d,v:y}}function rf(r,i,a,s){var d=[Ot(Math.round(r).toString(16)),Ot(Math.round(i).toString(16)),Ot(Math.round(a).toString(16))];return s&&d[0].charAt(0)==d[0].charAt(1)&&d[1].charAt(0)==d[1].charAt(1)&&d[2].charAt(0)==d[2].charAt(1)?d[0].charAt(0)+d[1].charAt(0)+d[2].charAt(0):d.join("")}function of(r,i,a,s){return[Ot(Qf(s)),Ot(Math.round(r).toString(16)),Ot(Math.round(i).toString(16)),Ot(Math.round(a).toString(16))].join("")}function J1(r,i){i=i===0?0:i||10;var a=oe(r).toHsl();return a.s-=i/100,a.s=_a(a.s),oe(a)}function ev(r,i){i=i===0?0:i||10;var a=oe(r).toHsl();return a.s+=i/100,a.s=_a(a.s),oe(a)}function tv(r){return oe(r).desaturate(100)}function nv(r,i){i=i===0?0:i||10;var a=oe(r).toHsl();return a.l+=i/100,a.l=_a(a.l),oe(a)}function rv(r,i){i=i===0?0:i||10;var a=oe(r).toRgb();return a.r=Math.max(0,Math.min(255,a.r-Math.round(-i/100*255))),a.g=Math.max(0,Math.min(255,a.g-Math.round(-i/100*255))),a.b=Math.max(0,Math.min(255,a.b-Math.round(-i/100*255))),oe(a)}function ov(r,i){i=i===0?0:i||10;var a=oe(r).toHsl();return a.l-=i/100,a.l=_a(a.l),oe(a)}function iv(r,i){var a=oe(r).toHsl(),s=(a.h+i)%360;return a.h=s<0?360+s:s,oe(a)}function av(r){var i=oe(r).toHsl();return i.h=(i.h+180)%360,oe(i)}function af(r,i){if(isNaN(i)||i<=0)throw new Error("Argument to polyad must be a positive number");for(var a=oe(r).toHsl(),s=[oe(r)],d=360/i,f=1;f<i;f++)s.push(oe({h:(a.h+f*d)%360,s:a.s,l:a.l}));return s}function lv(r){var i=oe(r).toHsl(),a=i.h;return[oe(r),oe({h:(a+72)%360,s:i.s,l:i.l}),oe({h:(a+216)%360,s:i.s,l:i.l})]}function sv(r,i,a){i=i||6,a=a||30;var s=oe(r).toHsl(),d=360/a,f=[oe(r)];for(s.h=(s.h-(d*i>>1)+720)%360;--i;)s.h=(s.h+d)%360,f.push(oe(s));return f}function uv(r,i){i=i||6;for(var a=oe(r).toHsv(),s=a.h,d=a.s,f=a.v,m=[],y=1/i;i--;)m.push(oe({h:s,s:d,v:f})),f=(f+y)%1;return m}oe.prototype={isDark:function(){return this.getBrightness()<128},isLight:function(){return!this.isDark()},isValid:function(){return this._ok},getOriginalInput:function(){return this._originalInput},getFormat:function(){return this._format},getAlpha:function(){return this._a},getBrightness:function(){var r=this.toRgb();return(299*r.r+587*r.g+114*r.b)/1e3},getLuminance:function(){var r,i,a,s=this.toRgb();return r=s.r/255,i=s.g/255,a=s.b/255,.2126*(r<=.03928?r/12.92:Math.pow((r+.055)/1.055,2.4))+.7152*(i<=.03928?i/12.92:Math.pow((i+.055)/1.055,2.4))+.0722*(a<=.03928?a/12.92:Math.pow((a+.055)/1.055,2.4))},setAlpha:function(r){return this._a=qf(r),this._roundA=Math.round(100*this._a)/100,this},toHsv:function(){var r=nf(this._r,this._g,this._b);return{h:360*r.h,s:r.s,v:r.v,a:this._a}},toHsvString:function(){var r=nf(this._r,this._g,this._b),i=Math.round(360*r.h),a=Math.round(100*r.s),s=Math.round(100*r.v);return this._a==1?"hsv("+i+", "+a+"%, "+s+"%)":"hsva("+i+", "+a+"%, "+s+"%, "+this._roundA+")"},toHsl:function(){var r=tf(this._r,this._g,this._b);return{h:360*r.h,s:r.s,l:r.l,a:this._a}},toHslString:function(){var r=tf(this._r,this._g,this._b),i=Math.round(360*r.h),a=Math.round(100*r.s),s=Math.round(100*r.l);return this._a==1?"hsl("+i+", "+a+"%, "+s+"%)":"hsla("+i+", "+a+"%, "+s+"%, "+this._roundA+")"},toHex:function(r){return rf(this._r,this._g,this._b,r)},toHexString:function(r){return"#"+this.toHex(r)},toHex8:function(r){return(function(i,a,s,d,f){var m=[Ot(Math.round(i).toString(16)),Ot(Math.round(a).toString(16)),Ot(Math.round(s).toString(16)),Ot(Qf(d))];return f&&m[0].charAt(0)==m[0].charAt(1)&&m[1].charAt(0)==m[1].charAt(1)&&m[2].charAt(0)==m[2].charAt(1)&&m[3].charAt(0)==m[3].charAt(1)?m[0].charAt(0)+m[1].charAt(0)+m[2].charAt(0)+m[3].charAt(0):m.join("")})(this._r,this._g,this._b,this._a,r)},toHex8String:function(r){return"#"+this.toHex8(r)},toRgb:function(){return{r:Math.round(this._r),g:Math.round(this._g),b:Math.round(this._b),a:this._a}},toRgbString:function(){return this._a==1?"rgb("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+")":"rgba("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+", "+this._roundA+")"},toPercentageRgb:function(){return{r:Math.round(100*Re(this._r,255))+"%",g:Math.round(100*Re(this._g,255))+"%",b:Math.round(100*Re(this._b,255))+"%",a:this._a}},toPercentageRgbString:function(){return this._a==1?"rgb("+Math.round(100*Re(this._r,255))+"%, "+Math.round(100*Re(this._g,255))+"%, "+Math.round(100*Re(this._b,255))+"%)":"rgba("+Math.round(100*Re(this._r,255))+"%, "+Math.round(100*Re(this._g,255))+"%, "+Math.round(100*Re(this._b,255))+"%, "+this._roundA+")"},toName:function(){return this._a===0?"transparent":!(this._a<1)&&(cv[rf(this._r,this._g,this._b,!0)]||!1)},toFilter:function(r){var i="#"+of(this._r,this._g,this._b,this._a),a=i,s=this._gradientType?"GradientType = 1, ":"";if(r){var d=oe(r);a="#"+of(d._r,d._g,d._b,d._a)}return"progid:DXImageTransform.Microsoft.gradient("+s+"startColorstr="+i+",endColorstr="+a+")"},toString:function(r){var i=!!r;r=r||this._format;var a=!1,s=this._a<1&&this._a>=0;return i||!s||r!=="hex"&&r!=="hex6"&&r!=="hex3"&&r!=="hex4"&&r!=="hex8"&&r!=="name"?(r==="rgb"&&(a=this.toRgbString()),r==="prgb"&&(a=this.toPercentageRgbString()),r!=="hex"&&r!=="hex6"||(a=this.toHexString()),r==="hex3"&&(a=this.toHexString(!0)),r==="hex4"&&(a=this.toHex8String(!0)),r==="hex8"&&(a=this.toHex8String()),r==="name"&&(a=this.toName()),r==="hsl"&&(a=this.toHslString()),r==="hsv"&&(a=this.toHsvString()),a||this.toHexString()):r==="name"&&this._a===0?this.toName():this.toRgbString()},clone:function(){return oe(this.toString())},_applyModification:function(r,i){var a=r.apply(null,[this].concat([].slice.call(i)));return this._r=a._r,this._g=a._g,this._b=a._b,this.setAlpha(a._a),this},lighten:function(){return this._applyModification(nv,arguments)},brighten:function(){return this._applyModification(rv,arguments)},darken:function(){return this._applyModification(ov,arguments)},desaturate:function(){return this._applyModification(J1,arguments)},saturate:function(){return this._applyModification(ev,arguments)},greyscale:function(){return this._applyModification(tv,arguments)},spin:function(){return this._applyModification(iv,arguments)},_applyCombination:function(r,i){return r.apply(null,[this].concat([].slice.call(i)))},analogous:function(){return this._applyCombination(sv,arguments)},complement:function(){return this._applyCombination(av,arguments)},monochromatic:function(){return this._applyCombination(uv,arguments)},splitcomplement:function(){return this._applyCombination(lv,arguments)},triad:function(){return this._applyCombination(af,[3])},tetrad:function(){return this._applyCombination(af,[4])}},oe.fromRatio=function(r,i){if(ha(r)=="object"){var a={};for(var s in r)r.hasOwnProperty(s)&&(a[s]=s==="a"?r[s]:uo(r[s]));r=a}return oe(r,i)},oe.equals=function(r,i){return!(!r||!i)&&oe(r).toRgbString()==oe(i).toRgbString()},oe.random=function(){return oe.fromRatio({r:Math.random(),g:Math.random(),b:Math.random()})},oe.mix=function(r,i,a){a=a===0?0:a||50;var s=oe(r).toRgb(),d=oe(i).toRgb(),f=a/100;return oe({r:(d.r-s.r)*f+s.r,g:(d.g-s.g)*f+s.g,b:(d.b-s.b)*f+s.b,a:(d.a-s.a)*f+s.a})},oe.readability=function(r,i){var a=oe(r),s=oe(i);return(Math.max(a.getLuminance(),s.getLuminance())+.05)/(Math.min(a.getLuminance(),s.getLuminance())+.05)},oe.isReadable=function(r,i,a){var s,d,f=oe.readability(r,i);switch(d=!1,(s=(function(m){var y,v;return y=((m=m||{level:"AA",size:"small"}).level||"AA").toUpperCase(),v=(m.size||"small").toLowerCase(),y!=="AA"&&y!=="AAA"&&(y="AA"),v!=="small"&&v!=="large"&&(v="small"),{level:y,size:v}})(a)).level+s.size){case"AAsmall":case"AAAlarge":d=f>=4.5;break;case"AAlarge":d=f>=3;break;case"AAAsmall":d=f>=7}return d},oe.mostReadable=function(r,i,a){var s,d,f,m,y=null,v=0;d=(a=a||{}).includeFallbackColors,f=a.level,m=a.size;for(var g=0;g<i.length;g++)(s=oe.readability(r,i[g]))>v&&(v=s,y=oe(i[g]));return oe.isReadable(r,y,{level:f,size:m})||!d?y:(a.includeFallbackColors=!1,oe.mostReadable(r,["#fff","#000"],a))};var $s=oe.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",darkgray:"a9a9a9",darkgreen:"006400",darkgrey:"a9a9a9",darkkhaki:"bdb76b",darkmagenta:"8b008b",darkolivegreen:"556b2f",darkorange:"ff8c00",darkorchid:"9932cc",darkred:"8b0000",darksalmon:"e9967a",darkseagreen:"8fbc8f",darkslateblue:"483d8b",darkslategray:"2f4f4f",darkslategrey:"2f4f4f",darkturquoise:"00ced1",darkviolet:"9400d3",deeppink:"ff1493",deepskyblue:"00bfff",dimgray:"696969",dimgrey:"696969",dodgerblue:"1e90ff",firebrick:"b22222",floralwhite:"fffaf0",forestgreen:"228b22",fuchsia:"f0f",gainsboro:"dcdcdc",ghostwhite:"f8f8ff",gold:"ffd700",goldenrod:"daa520",gray:"808080",green:"008000",greenyellow:"adff2f",grey:"808080",honeydew:"f0fff0",hotpink:"ff69b4",indianred:"cd5c5c",indigo:"4b0082",ivory:"fffff0",khaki:"f0e68c",lavender:"e6e6fa",lavenderblush:"fff0f5",lawngreen:"7cfc00",lemonchiffon:"fffacd",lightblue:"add8e6",lightcoral:"f08080",lightcyan:"e0ffff",lightgoldenrodyellow:"fafad2",lightgray:"d3d3d3",lightgreen:"90ee90",lightgrey:"d3d3d3",lightpink:"ffb6c1",lightsalmon:"ffa07a",lightseagreen:"20b2aa",lightskyblue:"87cefa",lightslategray:"789",lightslategrey:"789",lightsteelblue:"b0c4de",lightyellow:"ffffe0",lime:"0f0",limegreen:"32cd32",linen:"faf0e6",magenta:"f0f",maroon:"800000",mediumaquamarine:"66cdaa",mediumblue:"0000cd",mediumorchid:"ba55d3",mediumpurple:"9370db",mediumseagreen:"3cb371",mediumslateblue:"7b68ee",mediumspringgreen:"00fa9a",mediumturquoise:"48d1cc",mediumvioletred:"c71585",midnightblue:"191970",mintcream:"f5fffa",mistyrose:"ffe4e1",moccasin:"ffe4b5",navajowhite:"ffdead",navy:"000080",oldlace:"fdf5e6",olive:"808000",olivedrab:"6b8e23",orange:"ffa500",orangered:"ff4500",orchid:"da70d6",palegoldenrod:"eee8aa",palegreen:"98fb98",paleturquoise:"afeeee",palevioletred:"db7093",papayawhip:"ffefd5",peachpuff:"ffdab9",peru:"cd853f",pink:"ffc0cb",plum:"dda0dd",powderblue:"b0e0e6",purple:"800080",rebeccapurple:"663399",red:"f00",rosybrown:"bc8f8f",royalblue:"4169e1",saddlebrown:"8b4513",salmon:"fa8072",sandybrown:"f4a460",seagreen:"2e8b57",seashell:"fff5ee",sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},cv=oe.hexNames=(function(r){var i={};for(var a in r)r.hasOwnProperty(a)&&(i[r[a]]=a);return i})($s);function qf(r){return r=parseFloat(r),(isNaN(r)||r<0||r>1)&&(r=1),r}function Re(r,i){(function(s){return typeof s=="string"&&s.indexOf(".")!=-1&&parseFloat(s)===1})(r)&&(r="100%");var a=(function(s){return typeof s=="string"&&s.indexOf("%")!=-1})(r);return r=Math.min(i,Math.max(0,parseFloat(r))),a&&(r=parseInt(r*i,10)/100),Math.abs(r-i)<1e-6?1:r%i/parseFloat(i)}function _a(r){return Math.min(1,Math.max(0,r))}function ft(r){return parseInt(r,16)}function Ot(r){return r.length==1?"0"+r:""+r}function uo(r){return r<=1&&(r=100*r+"%"),r}function Qf(r){return Math.round(255*parseFloat(r)).toString(16)}function lf(r){return ft(r)/255}var Nn,Zi,$i,Nt=(Zi="[\\s|\\(]+("+(Nn="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)")+")[,|\\s]+("+Nn+")[,|\\s]+("+Nn+")\\s*\\)?",$i="[\\s|\\(]+("+Nn+")[,|\\s]+("+Nn+")[,|\\s]+("+Nn+")[,|\\s]+("+Nn+")\\s*\\)?",{CSS_UNIT:new RegExp(Nn),rgb:new RegExp("rgb"+Zi),rgba:new RegExp("rgba"+$i),hsl:new RegExp("hsl"+Zi),hsla:new RegExp("hsla"+$i),hsv:new RegExp("hsv"+Zi),hsva:new RegExp("hsva"+$i),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/});function Jt(r){return!!Nt.CSS_UNIT.exec(r)}var xo=function(r,i){var a=(typeof r=="string"?parseInt(r):r)||0;if(a>=-5&&a<=5){var s=a,d=parseFloat(i),f=d+s*(d/5)*-1;return(f==0||f<=Number.EPSILON)&&(f=.1),{animationPeriod:f+"s"}}return{animationPeriod:i}},wo=function(r,i){var a=r||{},s="";switch(i){case"small":s="12px";break;case"medium":s="16px";break;case"large":s="20px";break;default:s=void 0}var d={};if(a.fontSize){var f=a.fontSize;d=(function(m,y){var v={};for(var g in m)Object.prototype.hasOwnProperty.call(m,g)&&y.indexOf(g)<0&&(v[g]=m[g]);if(m!=null&&typeof Object.getOwnPropertySymbols=="function"){var p=0;for(g=Object.getOwnPropertySymbols(m);p<g.length;p++)y.indexOf(g[p])<0&&Object.prototype.propertyIsEnumerable.call(m,g[p])&&(v[g[p]]=m[g[p]])}return v})(a,["fontSize"]),s=f}return{fontSize:s,styles:d}},dv={color:"currentColor",mixBlendMode:"difference",width:"unset",display:"block",paddingTop:"2px"},bo=function(r){var i=r.className,a=r.text,s=r.textColor,d=r.staticText,f=r.style;return a?xe.createElement("span",{className:"rli-d-i-b rli-text-format ".concat(i||"").trim(),style:me(me(me({},d&&dv),s&&{color:s,mixBlendMode:"unset"}),f&&f)},typeof a=="string"&&a.length?a:"loading"):null},tn="rgb(50, 205, 50)";function ko(r,i){if(i===void 0&&(i=0),r.length===0)throw new Error("Input array cannot be empty!");var a=[];return(function s(d,f){return f===void 0&&(f=0),a.push.apply(a,d),a.length<f&&s(a,f),a.slice(0,f)})(r,i)}Ue(`.atom-rli-bounding-box {
...
}`);var ea=Array.from({length:4},(function(r,i){return"--OP-spokes-phase".concat(i+1,"-color")})),hv=function(r){var i,a=wo(r?.style,r?.size),s=a.styles,d=a.fontSize,f=r?.easing,m=xo(r?.speedPlus,"1.2s").animationPeriod,y=(function(g){var p={},x=ea.length;if(g instanceof Array){for(var N=ko(g,x),k=0;k<N.length&&!(k>=4);k++)p[ea[k]]=N[k];return p}try{if(typeof g!="string")throw new Error("Color String expected");for(var b=0;b<x;b++)p[ea[b]]=g}catch(C){for(C instanceof Error?console.warn("[".concat(C.message,']: Received "').concat(typeof g,'" instead with value, ').concat(JSON.stringify(g))):console.warn("".concat(JSON.stringify(g),' received in <OrbitProgress variant="spokes" /> indicator cannot be processed. Using default instead!')),b=0;b<x;b++)p[ea[b]]=tn}return p})((i=r?.color)!==null&&i!==void 0?i:""),v=r?.dense?16:12;return xe.createElement("span",{className:"rli-d-i-b OP-spokes-rli-bounding-box",style:me(me(me(me(me({},d&&{fontSize:d}),m&&{"--rli-animation-duration":m}),f&&{"--rli-animation-function":f}),y),s),role:"status","aria-live":"polite","aria-label":"Loading"},xe.createElement("span",{className:"rli-d-i-b OP-spokes-indicator"},Array.from({length:v},(function(g,p){return xe.createElement("span",{key:Xf(),className:"rli-d-i-b spoke",style:mv(p,v,m)})}))),xe.createElement(bo,{text:r?.text,textColor:r?.textColor}))};function mv(r,i,a){if(i===16){var s=i-r,d=Number.parseFloat(a)/i;return{transform:"rotate(".concat(360*r/i,"deg) translate(-50%, ").concat("-1.56em",")"),animationDelay:"".concat((s-1)*d*-1,"s")}}}Ue(`.OP-annulus-dual-sectors-rli-bounding-box {
